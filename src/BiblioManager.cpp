...
void BiblioManager::print_html(std::ostream &out, const std::string &filename, ArticleInfo &result) {
    ...
    out << result.get_title();
    if (result.get_type() != "") {
        out << " " << result.get_type() << ".";
    }
    if (result.get_venue() != "") {
        out << " " << result.get_venue() << ".";
    }
    if (result.get_volume() != "") {
        out << " " << result.get_volume() << ".";
    }
    if (result.get_year() != "") {
        out << " " << result.get_year() << ".";
    }
    if (result.get_pages() != "") {
        out << " " << result.get_pages() << ".";
    }
    if (result.get_number() != "") {
        out << " " << result.get_number() << ".";
    }
    if (result.get_url() != "") {
        out << "\n" << result.get_url() << endl;
    }
...
ArticleInfo BiblioManager::search_distance_requesters(std::vector<Requester*> requesters, 
